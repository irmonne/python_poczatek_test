import random
from Module_2.shop_4.order_element import order_element_1, order_element_2, OrderElement
from Module_2.shop_4.produkt import Produkt, product_2
from Module_2.shop_4.discount_policy import DiscountPolicy
...
class Zamowienie:
    ...
    def __init__(self, first_name, last_name, order_element_list=None, discount_policy=None):
        ...
        if discount_policy is None:
            discount_policy = DiscountPolicy.no_discount_policy
        self.discount_policy = discount_policy
        self.order_value = discount_policy(self._order_element_list)
    ...
    def create_random_order(cls):
        ...
        order = Zamowienie(first_name="X", last_name="Y", order_element_list=_order_element_list, discount_policy=DiscountPolicy.christmas_discount_policy)
        return order

    def add_order_element(self, product, amount, discount_policy=None):
